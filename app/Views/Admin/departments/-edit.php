<div class="mb-6">
    <nav class="flex items-center text-sm text-gray-600 mb-3">
        ...
        <span class="text-gray-900 font-medium">Edit Departemen</span>
    </nav>
    <h1 class="text-2xl font-bold text-gray-800">Edit Departemen</h1>
    <p class="text-sm text-gray-600 mt-1">Perbarui informasi departemen <?= htmlspecialchars($data['department']['department_name']) ?></p>
</div>

<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6">
        <form action="<?= BASEURL ?>/admin/departments/update/<?= $data['department']['id'] ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           required
                           value="<?= htmlspecialchars($data['department']['department_code']) ?>"
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required
                           value="<?= htmlspecialchars($data['department']['department_name']) ?>"
                ...
                <select id="manager_id" 
                    ...
                    if(isset($data['employees'])): 
                        foreach ($data['employees'] as $emp): 
                            $selected = ($data['department']['manager_id'] == $emp['id']) ? 'selected' : '';
                    ?>
